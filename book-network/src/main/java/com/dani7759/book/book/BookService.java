...
import com.dani7759.book.common.PageResponse;
import com.dani7759.book.exception.OperationNotPermittedException;
import com.dani7759.book.file.SupabaseStorageService;
import com.dani7759.book.history.BookTransactionHistory;
import com.dani7759.book.history.BookTransactionHistoryRepository;
...
import static com.dani7759.book.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        updateShareableStatus(bookId, connectedUser);
    ...
    public void uploadBookCoverPicture(MultipartFile file, Authentication connectedUser, Integer bookId) throws IOException {
        Book book = bookRepository.findById(bookId)
                .orElseThrow(() -> new EntityNotFoundException("No book found with the ID:: " + bookId));
        User user = ((User) connectedUser.getPrincipal());
        var bookCover = supabaseStorageService.uploadFile(file);
        book.setBookCover(bookCover);
        bookRepository.save(book);
    }

    public PageResponse<BookResponse> findEveryoneBook(int page, int size) {
        Pageable pageable = PageRequest.of(page, size, Sort.by("createdDate").descending());
